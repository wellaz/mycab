...
public class InvestmentPrintable implements Printable {

	String amoun, partner, dated, receiver, receiptNumber, currency;

	public InvestmentPrintable(String amoun, String partner, String dated, String receiver, String receiptNumber,
			String currency) {
		super();
		this.amoun = amoun;
	...
	public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
		...
		if (pageIndex == 0) {
			...
			try {
				...
				// size
				g2d.setFont(font);
				g2d.drawString("\u00A9 " + new DateUtility().getYear() + "\u2192  Equation \u2122 (W.M)", 30, y + 130);
				// end of the reciept
			} catch (Exception r) {
				r.printStackTrace();
			}
