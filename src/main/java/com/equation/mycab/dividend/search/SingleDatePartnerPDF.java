...
public class SingleDatePartnerPDF {

	public SingleDatePartnerPDF() {
		super();
		return;
	}

	@SuppressWarnings({})
	public void generatePDF(Table table, Button download, String datePosted, String total) {
		try {
			...
			document.add(new Paragraph(datePosted + " Dividend Statement",
