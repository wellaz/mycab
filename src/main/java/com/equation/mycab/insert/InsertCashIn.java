...
public class InsertCashIn {
	...
	public void insertData(Statement stm, String driverId, String amount, String currency, String datePosted,
		...
		String query = "INSERT INTO cashin(driverId,amount,currency,datePosted,timePosted,receiptId)VALUES('"
				+ driverId + "','" + amount + "','" + currency + "','" + datePosted + "','" + timePosted + "','"
				+ receiptId + "')";
		try {
			stm.execute(query);
