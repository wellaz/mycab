...
public class ListCarsPDF {
	...
	@SuppressWarnings({})
	public void generatePDF(Table table, Button download, String total) {
		try {
			...
			document.add(new Paragraph("Assets / Cars",
			...
			PdfPCell cell = new PdfPCell(new Paragraph("List".toUpperCase(),
