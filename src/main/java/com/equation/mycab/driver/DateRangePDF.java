...
public class DateRangePDF {
	...
	@SuppressWarnings({})
	public void generatePDF(Table table, Button download, String from, String to, String total, String currency) {
		try {
			String filename = currency + "_statement" + ".pdf";
