...
public class SingleDatePDF {

	public SingleDatePDF() {
		super();
		return;
	}

	@SuppressWarnings({})
	public void generatePDF(Table table, Button download, String datePosted, String total, String currency) {
		try {
			...
			document.add(new Paragraph(datePosted + " Payment Statement",
