...
public class WithdrawalPrintable implements Printable {

	String amoun, partner, due, dated, receiver, receiptNumber, currency;

	public WithdrawalPrintable(String amoun, String partner, String due, String dated, String receiver,
	...
	public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
		...
		if (pageIndex == 0) {
			...
			try {
				/* Draw Header */
				int y = 80;
				g2d.drawString("Withdrawal Slip".toUpperCase(), 0, y);
				...
				g2d.drawString("Due Date " + due, 10, y + 120);
